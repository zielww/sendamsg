...
<head>
    ...
    <title>SendAMsg</title>

    <!-- FavIcon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('images/logos/default.png') }}">
...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <!-- Navbar -->
    <nav class="navbar justify-around border-b border-base-300">
        <!-- Logo -->
        <a href="/" class="text-lg">
            <p class="font-beanie text-4xl font-normal">sendamsg</p>
        </a>
        ...
        <div class="dropdown dropdown-end sm:hidden">
            ...
            <ul tabindex="0" class="dropdown-content menu z-[1] bg-base-200 p-4 rounded-box shadow w-64 gap-2">
                ...
                <label class="swap swap-rotate ml-2">
                    ...
                    <input type="checkbox" data-toggle-theme="black" />
        ...
        <!-- Menu for desktop -->
        <div class="hidden sm:flex gap-2 font-thin">
            <x-nav-link href="/write" :active="request()->is('write')">Write</x-nav-link>
            <x-nav-link href="/browse" :active="request()->is('browse')">Browse</x-nav-link>
            <x-nav-link href="/history" :active="request()->is('history')">History</x-nav-link>
            <x-nav-link href="/support" :active="request()->is('support')">Support</x-nav-link>
